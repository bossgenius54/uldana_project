                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" id="title" value="{{old('title', $lesson->title)}}" name="title" class="form-control">
                            @if ($errors->has('title'))
                        ...
                        <textarea id="laraberg" name="content" hidden>{{old('content', $lesson->content)}}</textarea>
